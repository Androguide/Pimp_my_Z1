...
public class CardSpinnerSchedMC extends Card {

    public CardSpinnerSchedMC(String title, String desc, String color, String prop, int currentItem, ArrayList<String> spinnerEntries, ActionBarActivity fa, AdapterView.OnItemSelectedListener onItemSelectedListener) {
