...
public class CardSpinnerSchedMCDisabled extends Card {

    public CardSpinnerSchedMCDisabled(String title, String desc, String color, String prop, int currentItem, ArrayList<String> spinnerEntries, ActionBarActivity fa, AdapterView.OnItemSelectedListener onItemSelectedListener) {
