...
public class CardSpinner extends Card {
    ...
    public CardSpinner(String title, String desc, String prop, int currentItem, ArrayList<String> spinnerEntries, ActionBarActivity fa, AdapterView.OnItemSelectedListener onItemSelectedListener) {
        super(title, desc, prop, currentItem, spinnerEntries, fa, onItemSelectedListener);
    }
